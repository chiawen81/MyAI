...
import"./chunk-5XUXGTUW.mjs";var e=Object.freeze({displayName:"Emacs Lisp",fileTypes:["el","elc","eld","spacemacs","_emacs","emacs","emacs.desktop","abbrev_defs","Project.ede","Cask","gnus","viper"],firstLineMatch:`(?x)
# Hashbang
^\\#!.*(?:\\s|\\/|(?<=!)\\b)
	emacs
(?:$|\\s)
