...
var angular_inline_style = [...scss, lang];
...
var lang2 = Object.freeze({
  ...
  "embeddedLangs": ["angular-html", "angular-template"]
});
var angular_inline_template = [...angular_html, ...angular_template, lang2];
...
\\s*(?:(\\])((?:[^*\\s]|\\*[^\\s/])+)?|(?=\\*/))`,
  ...
  "embeddedLangs": ["angular-expression", "angular-inline-style", "angular-inline-template", "angular-let-declaration", "angular-template", "angular-template-blocks"]
});
var angularTs = [...angular_expression, ...angular_inline_style, ...angular_inline_template, ...angular_let_declaration, ...angular_template, ...angular_template_blocks, lang3];
export {
  angularTs as default
};
//# sourceMappingURL=angular-ts-HS6DGEKE.js.map
