...
var lang = Object.freeze({
  "displayName": "COBOL",
  "fileTypes": ["ccp", "scbl", "cobol", "cbl", "cblle", "cblsrce", "cblcpy", "lks", "pdv", "cpy", "copybook", "cobcopy", "fd", "sel", "scb", "scbl", "sqlcblle", "cob", "dds", "def", "src", "ss", "wks", "bib", "pco"],
  "name": "cobol",
  "patterns": [{
    "match": "(^[ \\*][ \\*][ \\*][ \\*][ \\*][ \\*])([dD]\\s.*$)",
...
var cobol = [...sql, ...html, ...java, lang];
export {
  cobol as default
};
//# sourceMappingURL=cobol-Y2OEOY7U.js.map
