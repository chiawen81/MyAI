  ...
  "repository": {
    ...
    "css-template": {
      ...
      "patterns": [{
        ...
        "name": "params.css-template.templ",
        "patterns": [{
          "include": "source.go"
        }]
      }, {
        ...
        "patterns": [{
          ...
          "end": "(?<=;$)",
          "name": "property.css-template.templ",
          "patterns": [{
            "begin": "({)",
            "beginCaptures": {
              "1": {
            ...
            "name": "expression.property.css-template.templ",
            "patterns": [{
              "include": "source.go"
            }]
          }, {
            ...
            "match": "(.*)(;)$",
            "name": "constant.property.css-template.templ"
          }]
        }]
      }]
    },
    ...
    "html-template": {
      ...
      "patterns": [{
        ...
        "name": "params.html-template.templ",
        "patterns": [{
          "include": "source.go"
        }]
      }, {
    ...
    "script-template": {
      ...
      "patterns": [{
        ...
        "name": "params.script-template.templ",
        "patterns": [{
          "include": "source.go"
        }]
      }, {
        ...
        "name": "block.script-template.templ",
        "patterns": [{
          "include": "source.js"
        }]
      }]
...
var templ = [...go, ...javascript, ...css, lang];
export {
  templ as default
};
//# sourceMappingURL=templ-CYA6A4HN.js.map
